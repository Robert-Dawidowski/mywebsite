                ...
                <div className={classNames('col-md-6')}>
                    <section>
                        ...
                        <p>
                            ...
                            in Warsaw. I also hold a Engineering degree in computer science. Since the age of 16, I have
                            delved into numerous programming languages.
                            I was interested in the frontend, because I love the idea that I can be responsible for the
                            appearance of a tiny part of our world.
                        </p>
                    </section>
                </div>
                <div className={classNames('col-md-6 text-center')}>
